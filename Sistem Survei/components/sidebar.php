...
<aside id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-item">
            <a href="#" class="sidebar-link link-underline link-underline-opacity-0 collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#saw" aria-expanded="false" aria-controls="saw">
                <i class="lni lni-stats-up"></i>
                <span>SBP - SAW</span>
            </a>
            <ul id="saw" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                <li class="sidebar-item">
                    <a href="?page=admin/saw/alternatif" class="sidebar-link link-underline link-underline-opacity-0">Alternatif</a>
                </li>
                <li class="sidebar-item">
                    <a href="?page=admin/saw/bobot" class="sidebar-link link-underline link-underline-opacity-0">Bobot & Kriteria</a>
                </li>
                <li class="sidebar-item">
                    <a href="?page=admin/saw/matriks" class="sidebar-link link-underline link-underline-opacity-0">Matriks</a>
                </li>
            </ul>
        </li>
        <li class="sidebar-item">
