...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2024 at 09:30 PM
-- Server version: 10.4.32-MariaDB
-- PHP Version: 8.2.12
create database survei;
use survei;
...
INSERT INTO `bobot` (`kriteria`, `bobot`, `atribut`) VALUES
('Tangibles', 0.2, 'benefit'),
('Realiability', 0.2, 'benefit'),
('Responsiveness', 0.2, 'benefit'),
('Assurance', 0.2, 'benefit'),
('Empathy', 0.2, 'benefit');
...
--
ALTER TABLE `m_survey_soal`
  MODIFY `soal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
...
--
ALTER TABLE `t_jawaban_mahasiswa`
  MODIFY `jawaban_mahasiswa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=217;
...
--
ALTER TABLE `t_responden_mahasiswa`
  MODIFY `responden_mahasiswa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
